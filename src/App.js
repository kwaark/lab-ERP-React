...
function App() {
  return (
    <div className="container">
      <a className="links" id="paracadastro" href="#paracadastro">Cadastrar</a>
      <a className="links" id="paralogin" href="#paralogin">Login</a>
        ...
        <div id="login">
          <form method="post" action="">
            ...
            <p>
              ...
              <input id="senha_login" name="senha_login" required="required" type="password" placeholder="123abc"/>
            </p>
        ...
        <div id="cadastro">
          <form method="post" action="">
            ...
            <p>
              ...
              <input id="senha_cad" name="senha_cad" required="required" type="password" placeholder="123abc"/>
            </p>
